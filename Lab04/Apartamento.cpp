...
Apartamento::Apartamento(const DtDireccion& direccion, float superficie, const DtFecha& anioConstruccion, int numeroID, int numeroPiso, bool tieneAscensor, float gastosComunes)
